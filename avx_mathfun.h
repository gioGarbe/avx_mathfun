...
/*
  suggested by Paul Russel on Aug 6, 2015 as a way to use both sse and avx
  mathfun in the same program.
  Need to include sse_mathfun.h BEFORE avx_mathfun.h
*/
#ifndef _SSE_MATHFUN_H_
typedef __m128i v4si; // vector of 4 int   (sse)
#endif
...
v8sf log256_ps(v8sf x) {
  ...
  e = _mm256_add_ps(e, one); // elimitane if one uses 0x7e above
